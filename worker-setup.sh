#!/bin/bash
# Secondary Node Kubernetes Setup Script
# Run this on Instance 2: 32.197.218.119
...
echo ""
echo "Next steps:"
echo "1. Go back to Master Node (34.200.249.8)"
echo "2. Run: sudo kubeadm init --pod-network-cidr=10.244.0.0/16 --advertise-address=172.31.7.113"
echo "3. Copy the 'kubeadm join' command output"
echo "4. Return here and run the join command"
echo ""
